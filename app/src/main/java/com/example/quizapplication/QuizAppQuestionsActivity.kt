...
class QuizAppQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    // The below code before the gap block is written for finalizing the project.
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // setting OnSetClickListener() to every option.
        ...
        mQuestionsList = Constants.getQuestions() //global variable
    ...
    private fun setQuestion() {
        defaultOptionsView()
        val question: Question = mQuestionsList!![mCurrentPosition - 1] // force unwrap with (!!) here
